...
Blufor_Teamleader createUnit [[(_missionpos select 0)+(random 10),(_missionpos select 1)+(random 10)], _group,format["this setcaptive true; this switchMove ""acts_InjuredCoughRifle02""; %1 = this",_soldier1]];
Blufor_Rifleman createUnit [[(_missionpos select 0),(_missionpos select 1)], _group,format["this setcaptive true; this switchMove ""acts_InjuredLookingRifle02""; %1 = this",_soldier2]];
Blufor_Autorifleman createUnit [[(_missionpos select 0)+(random 5),(_missionpos select 1)+(random 5)], _group,format["this setcaptive true; this switchMove ""acts_InjuredLookingRifle03""; %1 = this",_soldier3]];
// END CREATE SOLDIERS
...
[west, "_taskhandle", ["One of our patrols has been ambushed and requires immediate assistance", "Ambushed Patrol", "(getMarkerPos str(_markername)"], objNull, true] call BIS_fnc_taskCreate; 
...
_trg setTriggerStatements["this",format["[""%1"",%2,%3,%4,%5,""%6"",this] spawn duws_fnc_rescue_success",_markername,_soldier1,_soldier2,_soldier3,_MissionPos,_markername2], ""];
