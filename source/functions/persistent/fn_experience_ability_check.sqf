...
_handle = [player] spawn duws_fnc_experience_ability_stamina;
...
if (!isMultiplayer) then {
    _handle = [player] spawn duws_fnc_experience_ability_slowtime;
...
else
{
    ...
    _handle = [player] spawn duws_fnc_experience_ability_logistic;
...
_handle = [player] spawn duws_fnc_experience_ability_heal;
...
_handle = [player] spawn duws_fnc_experience_ability_fieldcomm;
...
_handle = [player] spawn duws_fnc_experience_ability_warrior;
...
_handle = [player] spawn duws_fnc_experience_ability_refit;
...
{
    _handle = [player] spawn duws_fnc_experience_ability_logistic_boost;
