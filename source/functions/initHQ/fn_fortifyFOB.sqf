...
_centerPos = _arguments select 0;
_fob = _arguments select 1;
...
// AA on the roof
_aaPod = createVehicle [Blufor_AA_Static, [0,0,0], [], 0, "NONE"];
_aaPod allowdamage false;
_aaPod setdamage 0;
_aaPod setpos [_centerPos select 0, _centerPos select 1,(_centerPos select 2)+3.109];

_fobGuard1 = _groupGuard createUnit [Blufor_Rifleman, _centerPos, [], 0, "FORM"]; 
_fobGuard1 moveinGunner _aaPod;

// GMG
_gl1Pod = createVehicle [Blufor_GMG_Static, [0,0,0], [], 0, "NONE"];
...
// AT
_atPod1 = createVehicle [Blufor_AT_Static, [0,0,0], [], 0, "NONE"];
...
// HMG
_atPod2 = createVehicle [Blufor_HMG_Static, [0,0,0], [], 0, "NONE"];
...
// GMG
_atPod3 = createVehicle [Blufor_GMG_Static, [0,0,0], [], 0, "NONE"];
...
_fob addAction ["<t color='#ff0066'>Replace FOB Defences (15CP)</t>", {_this call duws_fnc_refortifyFOB}, [_aaPod, _gl1Pod, _atPod1, _atPod2, _atPod3, _centerPos, _fob], 0, true, true, "", "_this == player"];