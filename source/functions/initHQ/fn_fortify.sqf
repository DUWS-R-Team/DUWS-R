...
_hq addAction ["<t color='#ff0066'>Replace Defences (20CP)</t>", {_this call duws_fnc_refortify}, [_aaPod, _gl1Pod, _atPod1, _atPod2, _atPod3, _centerPos, _hq], 0, true, true, "", "_this == player"];