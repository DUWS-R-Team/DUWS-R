...
if (true) then
{
_this = createVehicle ["Land_Wreck_Ural_F", [1818.2542, 5619.2583, 0.090222724], [], 0, "CAN_COLLIDE"];
_vehicle_34 = _this;
...
if (true) then
{
_this = createVehicle [Opfor_Quadbike, [1818.0513, 5627.2832, 0.11207256], [], 0, "CAN_COLLIDE"];
_vehicle_39 = _this;
