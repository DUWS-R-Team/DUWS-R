...
if (true) then
{
  _this = createVehicle [Opfor_Supplycrate, [1799.2623, 5582.4023, 9.5367432e-007], [], 0, "CAN_COLLIDE"];
  _vehicle_159 = _this;
...
if (true) then
{
  _this = createVehicle [Opfor_Supplycrate, [1809.151, 5571.9531, 1.9073486e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_204 = _this;
...
if (true) then
{
  _this = createVehicle [Opfor_Supplycrate, [1810.049, 5570.918, 6.1988831e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_207 = _this;
