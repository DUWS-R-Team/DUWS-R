...
if (true) then
{
  _this = createVehicle [Opfor_Truck_Open, [1802.9224, 5576.1797, 1.0490417e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_105 = _this;
...
if (true) then
{
  _this = createVehicle [Opfor_Truck_Covered, [1802.2045, 5585.0039, 8.5830688e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_107 = _this;
...
if (true) then
{
  _this = createVehicle [Opfor_Supplycrate, [1805.4933, 5574.2349, 1.3851749], [], 0, "CAN_COLLIDE"];
  _vehicle_183 = _this;
...
if (true) then
{
  _this = createVehicle [Opfor_MRAP, [1816.5087, 5582.4043], [], 0, "CAN_COLLIDE"];
  _vehicle_184 = _this;
