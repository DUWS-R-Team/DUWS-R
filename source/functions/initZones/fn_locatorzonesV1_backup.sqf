...
//           hint format["%1",_distance];
     ...
     _null = [format["Zone %1",_i],_points_zone,_zone_radius,_MissionPos,_fortified] spawn duws_fnc_createzone;     
     _found=true;
...
[_zones_array, getpos hq_blu1, [0,0,0], blufor_ap, opfor_ap, 2700,blufor_ai_skill,opfor_ai_skill, 1500] call duws_fnc_WARCOM_init; // 2700 is 40 mins
sleep 0.1;
savegame;
