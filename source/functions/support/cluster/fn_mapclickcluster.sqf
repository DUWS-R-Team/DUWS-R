/*
    ...
    Usage: 
        _null = [1, 250, 1, 90, 1, 6, 'grenade'] spawn duws_fnc_mapclickcluster;
...
OnMapSingleClick format["_null = [_pos,%2,%3,%4,%5,%6,%7,'%8'] spawn duws_fnc_cluster;
clicked=true;
onMapSingleClick ''",_pos,_salvos,_radius,_interval,_rps,_supportype,_cost,_ammotype];
