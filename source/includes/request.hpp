...
class ressourceheader
{
    ...
    class controls
    {
        ...
        class requestunitsbutton: RscButton
        {
            ...
            w = 11.5 * GUI_GRID_W;
            h = 1 * GUI_GRID_H;
            action = "[] call duws_fnc_request_unit";
        ...
        class requestsquadbutton: RscButton
        {
            ...
            w = 11.5 * GUI_GRID_W;
            h = 1 * GUI_GRID_H;
            action = "[] call duws_fnc_request_squad";
        ...
        class requestvehiclebutton: RscButton
        {
            ...
            action = "[] call duws_fnc_request_vehicle";
        };
        ...
        class RscButton_1605: RscButton
        {
            ...
            w = 10.5 * GUI_GRID_W;
            h = 1.5 * GUI_GRID_H;
            action = "_derp = [] spawn duws_fnc_stratmap; closeDialog 0";
        ...
        class convertCPbutton: RscButton
        {
            ...
            w = 11.5 * GUI_GRID_W;
            h = 1 * GUI_GRID_H;
            action = "[]call duws_fnc_convertCPtoAP";
        ...
        class recruit_operative_button: RscButton
        {
            ...
            w = 11.5 * GUI_GRID_W;
            h = 1 * GUI_GRID_H;
            action = "[] spawn duws_fnc_operator_open";
