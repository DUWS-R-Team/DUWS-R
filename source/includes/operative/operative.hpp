class operativemaingui
{
    ...
    class controls
    {
        ...
        class operative_listbox: RscListbox
        {
            ...
            w = 9.5 * GUI_GRID_W;
            h = 13.5 * GUI_GRID_H;
            onLBSelChanged  = "[] call duws_fnc_lbselected"; //UI event handler
        };
        ...
        class operative_add_aiming: RscButton
        {
            ...
            action  = "call duws_fnc_operator_add_aim";
        };
        class operative_add_reflexes: RscButton
        {
            ...
            h = 1 * GUI_GRID_H;
            tooltip = "Spend 1 point on this skill"; //--- ToDo: Localize;
            action  = "call duws_fnc_operator_add_reflexes";
        };
        class operative_add_spotting: RscButton
        {
            ...
            h = 1 * GUI_GRID_H;
            tooltip = "Spend 1 point on this skill"; //--- ToDo: Localize;
            action  = "call duws_fnc_operator_add_spotting";
        };
        class operative_add_courage: RscButton
        {
            ...
            h = 1 * GUI_GRID_H;
            tooltip = "Spend 1 point on this skill"; //--- ToDo: Localize;
            action  = "call duws_fnc_operator_add_courage";
        };
        class operative_add_comms: RscButton
        {
            ...
            h = 1 * GUI_GRID_H;
            tooltip = "Spend 1 point on this skill"; //--- ToDo: Localize;
            action  = "call duws_fnc_operator_add_comms";
        };
        class operative_add_reload: RscButton
        {
            ...
            h = 1 * GUI_GRID_H;
            tooltip = "Spend 1 point on this skill"; //--- ToDo: Localize;
            action  = "call duws_fnc_operator_add_reload";
        };
        ////////////////////////////////////////////////////////
